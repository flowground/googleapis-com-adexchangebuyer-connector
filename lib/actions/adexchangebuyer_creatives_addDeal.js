 ...
 *
 *
 * Operation: 'adexchangebuyer.creatives.addDeal'
 * Endpoint Path: '/creatives/{accountId}/{buyerCreativeId}/addDeal/{dealId}'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/creatives/{accountId}/{buyerCreativeId}/addDeal/{dealId}',
        method: 'post',
